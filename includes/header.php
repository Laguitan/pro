                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            while ($category = $stmt->fetch()) {
                                echo "<li><a class='dropdown-item' href='products.php?category={$category['id']}'>{$category['name']}</a></li>";
                            }
                            ?>
                        </ul>
                    </li>
                    ...
                    <?php if (isLoggedIn()): ?>
                        <li class="nav-item">
                            <a class="nav-link" href="cart.php">
                                ...
                                <span class="badge bg-warning text-dark"><?php echo getCartCount($pdo); ?></span>
                            </a>
                        </li>
                        <li class="nav-item dropdown">
